                ...
                <div class="card">
                    ...
                    <figure class="photo"><img src="${photo}"></figure>
                        ...
                        <div class="icons">
                            ...
                            <a class="icon" onclick="increaseLikes(${i})" " target="_blank" data-index="3"><span id="like_btn${i}">${like}</span><img src="${iDribbble}"></a>
                            </div>
                            </div>
                    </div>
                </div>`;
...
function increaseLikes(num) {
    team[num].like++
    document.getElementById("like_btn"+num).textContent = team[num].like
    console.log(num)
    //likeCount++; // 좋아요 개수 증가
//document.getElementById("like-count").textContent = "좋아요 개수:6 " + likeCount; // 화면에 업데이트
}
