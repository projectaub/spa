                ...
                <div class="card">
                    ...
                    <figure class="photo"><img src="${photo}"></figure>
                        ...
                        <div class="icons">
                            ...
                            <a class="icon" onclick="increaseLikes(${i})" target="_blank" data-index="3"><span class="like_btn${i}">${like}</span><img src="${iDribbble}"></a> */
                            </div>
                            </div>
                    </div>
                </div>`;
...
function increaseLikes(num) {
  team[num].like++;
  const like_buttons = document.getElementsByClassName("like_btn" + num);
